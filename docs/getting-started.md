...
description: "Complete installation guide and first steps for Another Claude-Code BMAD. Learn how to install, configure, and run your first BMAD workflow."
keywords: "BMAD installation, Claude Code setup, agile development setup, BMAD getting started"
---

# Getting Started

This guide will walk you through installing Another Claude-Code BMAD and running your first workflow.

> **Note:** This is an optimized fork of aj-geddes's BMAD implementation. See the [main page](./) for attribution and fork enhancements.
...
- A Bash terminal (Linux/macOS/WSL)
...
**What it does:**
- Installs 10 skills to `~/.claude/skills/`
...
Use **WSL** (Windows Subsystem for Linux) to run the bash installer:
...
Output saved to: ~/.claude/skills/qa-engineer/SKILL.md
...
Check the [Troubleshooting Guide](./troubleshooting) or [open an issue](https://github.com/tkristner/Another_Claude-Code_BMAD/issues)
