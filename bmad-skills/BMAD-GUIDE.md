...
### tech-writer
- Wants to create "documentation" or "docs"
- Needs "README" or "API docs"
- Asks for "user guide" or "tutorial"
- Wants to update "changelog" or "release notes"
...
- `/check-implementation-readiness` - Comprehensive Phase 3→4 gate validation
...
> **Need help choosing?** See [shared/resources/workflow-selection-guide.md](shared/resources/workflow-selection-guide.md) for decision trees and workflow comparisons.

> **Creating templates?** See [TEMPLATE-GUIDELINES.md](TEMPLATE-GUIDELINES.md) for style guide and checklist.
