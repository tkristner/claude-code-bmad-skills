...
**Adversarial Mindset:** Find 3-10 issues minimum. Zero findings is suspicious - dig deeper!

---

## Pre-Review Validation

- [ ] Story/PR loaded and requirements understood
- [ ] Git changes discovered (`git diff --name-only`)
- [ ] Git changes cross-referenced with claimed changes
- [ ] Project coding standards loaded (CLAUDE.md, project-context.md)
- [ ] Tech stack and test framework identified
...
- [ ] All [x] tasks verified as actually done (not just claimed)

---

## Git vs Claims Validation

**CRITICAL - Verify claims match reality:**

- [ ] All files claimed as modified show in git diff
- [ ] No files in git diff missing from File List/PR description
...
| Files changed but not documented | MEDIUM |
| Uncommitted changes not tracked | MEDIUM |
...
- [ ] Resources cleaned up in all paths (finally blocks, defer, etc.)
...
- [ ] **Tests have REAL assertions (not placeholder/TODO tests)**
...
| HIGH | | Yes - before merge |
| MEDIUM | | Recommended |
| LOW | | Optional |

**Minimum findings:** 3-10 (if fewer, re-examine code)
...
- **Baseline Commit:**
- **Review Commit:**
- **Approval:** [ ] Approved [ ] Needs changes [ ] Blocked
...
- [ ] Sprint tracking synced (if applicable)
- [ ] Change log updated

---

**Note:** This is a comprehensive checklist. Not all items apply to every change. Use judgment to focus on relevant items for the specific code being reviewed. However, finding 3-10 issues is expected - zero findings suggests insufficient review depth.
