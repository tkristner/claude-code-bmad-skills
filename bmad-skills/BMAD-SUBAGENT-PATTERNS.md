...
All BMAD skills implement subagent strategies documented in their SKILL.md:

| Skill | Primary Pattern | Use Case |
|-------|-----------------|----------|
| [bmad-orchestrator](bmad-orchestrator/SKILL.md) | Fan-Out Research | Status checks, project analysis |
| [business-analyst](business-analyst/SKILL.md) | Fan-Out Research | Product discovery, market research |
| [product-manager](product-manager/SKILL.md) | Parallel Section Generation | PRD creation, requirements documentation |
| [system-architect](system-architect/SKILL.md) | Fan-Out Research | Requirements analysis, architecture design |
| [scrum-master](scrum-master/SKILL.md) | Parallel Section Generation | Epic breakdown, story creation |
| [developer](developer/SKILL.md) | Story Parallel Implementation | Multi-story implementation |
| [ux-designer](ux-designer/SKILL.md) | Parallel Section Generation | Screen/flow design |
| [creative-intelligence](creative-intelligence/SKILL.md) | Fan-Out Research | Multi-technique brainstorming |
| [builder](builder/SKILL.md) | Parallel Component Creation | Skill creation, template generation |
