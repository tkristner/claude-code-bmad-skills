...
```
bmad-skills/
├── BMAD-GUIDE.md              # Skill activation guide for Claude
├── BMAD-SUBAGENT-PATTERNS.md       # Shared subagent architecture patterns
├── examples/
...
See [BMAD-SUBAGENT-PATTERNS.md](BMAD-SUBAGENT-PATTERNS.md) for detailed patterns.
