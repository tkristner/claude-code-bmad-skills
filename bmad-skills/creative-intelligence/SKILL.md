...
- Lead structured brainstorming sessions using proven techniques (SCAMPER, 5 Whys, Mind Mapping, etc.)
- Conduct market, competitive, technical, or user research
- Generate creative solutions to complex problems
- Explore ideas systematically across all project phases
...
6. **Actionable Insights** - Always extract concrete next steps from research

## Key Commands & Workflows

### /brainstorm
Facilitate structured brainstorming session using proven techniques.

**Workflow:** See [workflows/brainstorm.md](workflows/brainstorm.md)

**Process:** Define objective → Select techniques (2-3) → Execute systematically → Organize ideas → Extract insights

**Output:** Brainstorming document with categorized ideas and actionable insights

### /research
Conduct comprehensive research with structured analysis.

**Workflow:** See [workflows/research.md](workflows/research.md)

**Process:** Define scope → Select methods → Gather data → Analyze → Create matrix → Extract insights

**Output:** Research report with findings, competitive analysis, and recommendations
...
### Pattern 1: Parallel Domain Research
Launch multiple research agents simultaneously for comprehensive coverage:

```
Agent 1: Market research (trends, size, growth)
Agent 2: Competitive analysis (players, features, gaps)
Agent 3: Technical research (technologies, patterns)
...
```
Round 1: Broad scan → Identify key themes
Round 2: Deep dive on top 3 themes → Detailed findings
Round 3: Validation and gap filling → Complete picture
```

### Pattern 3: Competitive Intelligence Matrix
Structured comparison across multiple dimensions:

| Dimension | Competitor A | Competitor B | Our Position | Gap/Opportunity |
|-----------|--------------|--------------|--------------|-----------------|
| Features | ... | ... | ... | ... |
| Pricing | ... | ... | ... | ... |
| Target Market | ... | ... | ... | ... |
...
### Pattern 4: Trend Triangulation
Validate trends by cross-referencing multiple sources:
- Industry reports (Gartner, Forrester)
- News and publications
- Social media sentiment
- Patent filings
- Job postings (skill demand signals)

## Insights Synthesis Framework

### The Insight Extraction Process

Raw findings → Patterns → Themes → Insights → Actions

**Step 1: Organize Raw Findings**
- Group by source, topic, or stakeholder
- Tag each finding (positive/negative/neutral, certainty level)
- Remove duplicates while noting frequency
...
- Name each pattern cluster
- Describe the theme in one sentence
- Note supporting evidence count

**Step 4: Formulate Insights**
An insight is NOT a fact. An insight is an interpretation that leads to action.

| Bad (Just a Fact) | Good (Actionable Insight) |
|-------------------|---------------------------|
| "60% use mobile" | "Mobile-first design could capture underserved 60%" |
| "Competitor has feature X" | "Feature X gap risks churn; parity needed by Q2" |
| "Users complain about speed" | "Performance investment has highest satisfaction ROI" |
...
### Pattern: Research → Brief Handoff
**When:** Business Analyst starts product discovery
...
```
Before starting research/brainstorming:
[ ] Clarify objective with requesting skill
[ ] Agree on output format and location
[ ] Set scope boundaries (time, depth)
[ ] Identify key questions to answer

After completing:
[ ] Summarize top 3-5 actionable insights
[ ] Provide evidence/confidence levels
[ ] Recommend next steps
[ ] Save to agreed output location
```
